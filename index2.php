...
function docappointmentInputs(){
  $docopts = [
    ...
    for ($g = 0; $g < 2; $g++){
      echo '<a class="'.$first[$g]['bttn'].'" href="#customCarousel2" role="button" data-slide="'.$first[$g]['slide'].'">
      <i class="'.$first[$g]['dirr'].'" aria-hidden="true"></i>
      <span class="sr-only">'.$first[$g]['txt'].'</span>
    </a>';
    };
